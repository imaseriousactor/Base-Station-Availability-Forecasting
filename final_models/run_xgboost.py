...
from models.xgboost_model import DEFAULT_PARAMS, build_model, suggest_params
...
def objective(trial):
    ...
    cv_res = run_time_series_cv(
        X_train, y_train, get_model, n_splits=3, use_scaler=False, verbose=False
    )
...
feat_imp_xgb = pd.DataFrame(
    {"feature": X_train.columns, "importance": model_xgb.feature_importances_}
